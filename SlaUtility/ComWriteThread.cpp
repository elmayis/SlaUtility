...
void CComWriteThread::FireConnect(const ConnectFinishedDelegate& oConnectFinishedDelegate, const CComSettings& oComSettings)
{
...
void CComWriteThread::OnConnect(WPARAM wParam, LPARAM lParam)
{
...
bool CComWriteThread::OpenComm(void)
{
   CString sCommPort;
...
bool CComWriteThread::UpdateCommSettings(void)
{
   DCB oDcb;
